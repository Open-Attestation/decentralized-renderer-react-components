...
^ This is a weird explanation. Were you trying to say that triggering an event without DOM changes will not fire `onUpdate`?
^ Might want to consider showing that it does not work for iframe ie. dom < iframe < iframe stuffs.
